...
These test assets make synthetic English and Japanese OCR tests independent of the operating system's installed fonts and network access.
...
The font files are licensed under the [SIL Open Font License, Version 1.1](OFL.txt). They are test assets only and are not loaded by product code.
